...
export default function LayananLayout({ children }) {
  ...
  const getHeaderInfo = () => {
    ...
    if (pathname.includes('/pemindahan')) return { title: 'Layanan Pemindahan', desc: 'Layanan informasi dan formulir permohonan pemindahan Warga Binaan Pemasyarakatan.', icon: '🚌' };
