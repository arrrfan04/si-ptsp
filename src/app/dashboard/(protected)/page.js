    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h2 style={{ fontSize: '2.5rem', marginBottom: '1rem', fontFamily: 'Outfit, sans-serif', fontWeight: 800, color: 'white' }}>
            Halo, {username}! 👋
          </h2>
          <p style={{ fontSize: '1.15rem', color: 'rgba(255,255,255,0.7)', maxWidth: '650px', lineHeight: 1.7, marginBottom: '2.5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
        <div style={{ padding: '2rem', backgroundColor: 'white', borderRadius: '1.5rem', border: '1px solid #E2E8F0', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
          ...
          <p style={{ fontSize: '2.5rem', fontWeight: 800, color: '#0F172A', fontFamily: 'Outfit' }}>{stats.totalVisitors}</p>
        ...
        <div style={{ padding: '2rem', backgroundColor: 'white', borderRadius: '1.5rem', border: '1px solid #E2E8F0', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
          ...
          <p style={{ fontSize: '2.5rem', fontWeight: 800, color: '#0F172A', fontFamily: 'Outfit' }}>{stats.totalNews}</p>
        ...
        <div style={{ padding: '2rem', backgroundColor: 'white', borderRadius: '1.5rem', border: '1px solid #E2E8F0', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
          ...
          <p style={{ fontSize: '2.5rem', fontWeight: 800, color: '#0F172A', fontFamily: 'Outfit' }}>{stats.totalRemissions}</p>
